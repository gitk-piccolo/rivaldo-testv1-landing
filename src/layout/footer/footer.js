        ...
        return (
            <footer className="py-11 bg-primary position-relative" data-bg-img="assets/images/bg/03.png">
                    ...
                    <Row className="mt-5" >
                        <Col className="col-12 col-sm-6">
                            <Link className="footer-logo text-white h2 mb-0" to="/">
                                Pm<span className="font-weight-bold">International</span>
                            </Link> 
                        </Col>
                ...
                <Row className="text-white text-center mt-8">
                    <Col>
                    <hr className="mb-8" />Copyright 2021 &copy;<u><Link className="text-white" to="#">Pm International</Link></u>  | All Rights Reserved</Col>
                </Row>
                </Container>
            </footer>
        );
